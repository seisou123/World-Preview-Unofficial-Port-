...
- Noise render modes (temperature, humidity, continentalness, ...) now draw smooth perceptual color gradients instead of coarse posterized color bands; the temperature, humidity and continentalness ramps are anchored to the vanilla biome climate bands, so colors line up with real biome boundaries
