...
public final class ModCompatRegistry {
     ...
     *
     * <p>Uses NeoForge ModList to enumerate all installed mods
    ...
    /**
     * Detects installed mods using NeoForge ModList.
     *
     * <p>This method uses NeoForge ModList to enumerate
     * all installed mods
     * gracefully.
     *
    ...
    public static Set<String> detectInstalledMods() {
        ...
        try {
            ...
            LOGGER.info("Detected {} mods via NeoForge ModList", modIds.size());
        } catch (Exception e) {
            LOGGER.debug("Failed to detect mods via NeoForge ModList: {}", e.getMessage());
        }
        return modIds;
    }
