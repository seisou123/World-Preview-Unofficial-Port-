...
public class FullChunkWorkUnit extends WorkUnit {
    ...
    public FullChunkWorkUnit(WorkManager workManager, ChunkSampler sampler, ChunkPos pos, SampleUtils sampleUtils, PreviewData previewData, int yMin, int yMax, int yStride) {
