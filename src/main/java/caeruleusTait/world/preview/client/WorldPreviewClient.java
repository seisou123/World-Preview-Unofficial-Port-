...
public class WorldPreviewClient implements ClientModInitializer {
    ...
    public static void renderTexture(GuiGraphics guiGraphics, AbstractTexture texture, double xMin, double yMin, double xMax, double yMax) {
        ...
        try {
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texId, (int)xMin, (int)yMin, 0.0f, 0.0f, w, h, w, h);
        } catch (Exception e) {
