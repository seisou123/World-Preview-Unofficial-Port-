...
public final class SeedSearchOptionsScreen extends Screen {
    ...
    /** Y of the centered screen title, matching the extracted render pass. */
    ...
    private void drawRowLabel(GuiGraphicsExtractor graphics, Component label, AbstractWidget control) {
        graphics.text(font, label, columnX,
