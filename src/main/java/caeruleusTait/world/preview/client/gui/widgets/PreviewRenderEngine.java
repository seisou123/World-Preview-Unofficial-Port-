...
class PreviewRenderEngine {
    ...
    void renderStructures(List<RenderHelper> renderData, GuiGraphics guiGraphics) {
        renderStructures(renderData, guiGraphics, true);
    }
     ...
     */
    void renderStructures(List<RenderHelper> renderData, GuiGraphics guiGraphics, boolean updateHoverGrid) {
    ...
    void renderSpawnPin(GuiGraphics guiGraphics) {
        BlockPos pinPos = host.spawnPinPos();
        if (pinPos == null) return;
        renderStickyIcon(guiGraphics, playerIcon, pinPos);
    }

    void renderPlayerAndSpawn(GuiGraphics guiGraphics) {
