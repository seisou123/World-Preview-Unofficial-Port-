...
public class BiomePickerList extends BaseObjectSelectionList<BiomePickerList.Row> {
    ...
    @Override
    protected void renderSelection(@NotNull GuiGraphics guiGraphics, @NotNull Row entry, int color) {
    ...
    public class Row extends BaseObjectSelectionList.Entry<Row> {
        ...
        public void renderContent(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, boolean hovered, float partialTick) {
            ...
            guiGraphics.drawString(BiomePickerList.this.minecraft.font, rowText(), left + 5, top + 4, 0xFFFFFFFF);
        }
