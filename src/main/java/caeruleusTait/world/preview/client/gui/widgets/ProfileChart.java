 ...
 * ported MC versions, so a plain {@link GuiGraphics#fill} box keeps the
...
public final class ProfileChart extends AbstractWidget {
    ...
    private void renderHoverTooltip(GuiGraphics graphics, ProfilePoint point, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < lines.size(); i++) {
            graphics.drawString(font, lines.get(i), boxX + 4, boxY + 2 + i * font.lineHeight, TOOLTIP_TEXT);
        }
    }
