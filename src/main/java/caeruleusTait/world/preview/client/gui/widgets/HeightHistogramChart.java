 ...
 * {@link GuiGraphicsExtractor#fill} boxes instead of
...
public final class HeightHistogramChart extends AbstractWidget {
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, TITLE, getX() + 6, getY() + 6, 0xFFFFFFFF);
        ...
        for (int m = 0; m < markers.size(); m++) {
            ...
            graphics.text(font, marker.label(), labelX, top + m * MARKER_LABEL_ROW, marker.color());
        }
    ...
    private void renderHoverTooltip(GuiGraphicsExtractor graphics, Font font, int y, int count, int mouseX, int mouseY) {
        ...
        graphics.text(font, line, boxX + 4, boxY + 2, TOOLTIP_TEXT);
    }
