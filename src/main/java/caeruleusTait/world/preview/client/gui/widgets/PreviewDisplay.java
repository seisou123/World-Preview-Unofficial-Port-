...
resizeImage();
    ...
    @Override
    public void extractWidgetRenderState(GuiGraphicsExtractor guiGraphics, int x, int y, float f) {
        ...
        synchronized (dataProvider) {
            if (dataProvider.setupFailed()) {
                ...
                for (int i = 0; i < lines.size(); ++i) {
                    ...
                    guiGraphics.centeredText(minecraft.font, line, centerX, centerY + offsetY, 0xFFFFFFFF);
                }
                ...
                guiGraphics.centeredText(minecraft.font, MSG_PREVIEW_SETUP_LOADING, centerX, centerY, 0xFFFFFFFF);
            } else {
        ...
        if (coordinatesCopiedMsg != null) {
            ...
            guiGraphics.centeredText(minecraft.font, coordinatesCopiedMsg, xMin + ((xMax - xMin) / 2), yMax - 32, 0xFFFFFFFF);
        ...
        if (transientHudMsg != null) {
            ...
            guiGraphics.text(minecraft.font, transientHudMsg, hudX, hudY, 0xFFFFFFFF);
        ...
        if (config.showFrameTime) {
            ...
            guiGraphics.text(minecraft.font, frameInfo, 5, 5, 0xFFFFFFFF);
        }
        ...
        if (config.showCoordinates) {
            ...
            guiGraphics.text(minecraft.font, cachedCenterStr, xMin + 5, yMax - minecraft.font.lineHeight - 4, 0xFFFFFFFF);
        }
     ...
     */
    private void renderRegionOverlay(GuiGraphicsExtractor guiGraphics) {
    ...
    private void drawBlockRect(GuiGraphicsExtractor guiGraphics, int minX, int minZ, int maxX, int maxZ, int border, int fill) {
    ...
    private void drawRegionSelectHint(GuiGraphicsExtractor guiGraphics) {
        final int xMin = getX();
        ...
        guiGraphics.text(minecraft.font, REGION_SELECT_HINT, hx, hy, 0xFFFFFFFF);
    }
